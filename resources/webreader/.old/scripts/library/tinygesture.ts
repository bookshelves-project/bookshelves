...
interface Options {
  ...
  disregardVelocityThreshold: any
...
export default class TinyGesture {
  ...
  touchMoveX: any
  touchMoveY: any
  disregardVelocityThresholdX: any
  disregardVelocityThresholdY: any
  swipingHorizontal: any
  swipingVertical: any
  swipingDirection: any
  swipedHorizontal: any
  swipedVertical: any
...
const optionsDefault: Options = {
  threshold: (type: Gesture, self) => Math.max(
    25,
    Math.floor(
      0.15
          * (type === 'x'
  ...
  disregardVelocityThreshold: (type: Gesture, self) => Math.floor(
    0.5
