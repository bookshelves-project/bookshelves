<div id="sidebar">
    ...
    <div id="toc"
        class="-translate-x-full 2xl:translate-x-0 max-w-xs w-full pt-5 pb-4 transform transition duration-300 fixed left-0 top-0 bg-gray-100 dark:bg-gray-800 dark:text-white z-40 overflow-y-auto pl-4 h-screen">
    </div>
</div>
