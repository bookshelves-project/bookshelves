...
const Matice = {
  locale: 'en',
  fallbackLocale: 'en',
  translations: {'en':{'admin':{'yes':'Yes',
    'no':'No',
    'titles':{'index':'List :resource',
    ...
    'confirm':{'delete_title':'Delete :resource :label ?',
  ...
  'books':{'name':'Book|Books',
    'attributes':{'contributor':'Contributor',
      'rights':'Rights',
      'volume':'Volume',
      'serie':'Series',
      'disabled':'Disabled',
  ...
  'authors':{'name':'Author|Authors',
    'attributes':{'firstname':'Firstname',
      'lastname':'Lastname',
      'note':'Note'}},
  'submissions':{'name':'Submission|Submissions',
    'attributes':{'message':'Message'}},
  'tags':{'name':'Tag|Tags',
    'attributes':{'first_char':'First char',
      'type':'Type'}},
  'languages':{'name':'Language|Languages',
    'attributes':[]},
  'publishers':{'name':'Publisher|Publishers',
    'attributes':[]},
  'wikipedia-items':{'name':'Wikipedia Item|Wikipedia Items',
    'attributes':{'search_query':'Search query',
      'serie':'Series',
      'author':'Author',
      'page_id':'Page ID',
      'query_url':'Query URL'}},
  'google-books':{'name':'Google Book|Google Books',
    'attributes':{'original_isbn':'ISBN',
      'book':'book',
      'url':'url'}},
  'pages':{'name':'Page|Pages',
    'attributes':[]}},
  'enum':{'enum':'The :attribute field is not a valid :enum.',
    ...
    'enums':{'AuthorRoleEnum':{'aut':'Author'},
      'BookFormatEnum':{'epub':'EPUB',
        'cbz':'CBZ',
        'pdf':'PDF'},
      'BookTypeEnum':{'handbook':'Handbook',
        'essay':'Essay',
        'comic':'Comic',
        'novel':'Novel',
        'audio':'Audio'},
      ...
      'RoleEnum':{'super_admin':'Super admin',
        'admin':'Admin',
        'user':'User'},
      'SubmissionReasonEnum':{'idea':'Idea',
        'issue':'Issue',
  ...
  'fr':{'admin':{'yes':'Oui',
    ...
    'confirm':{'delete_title':'Supprimer :resource :label ?',
  ...
  'crud':{'users':{'name':'Utilisateur|Utilisateurs',
    'attributes':{'role':'R\u00f4le',
      'last_login_at':'Derni\u00e8rement connect\u00e9 le'}},
  'posts':{'name':'Article|Articles',
  ...
  'books':{'name':'Livre|Books',
    'attributes':{'volume':'Volume',
      ...
      'type':'Type',
      'publisher':'\u00c9diteur'}},
  'series':{'name':'S\u00e9rie|S\u00e9ries',
    'attributes':{'authors':'Auteurs',
      'language':'Langage'}},
  'authors':{'name':'Auteur|Auteurs',
    'attributes':{'firstname':'Pr\u00e9nom',
      'lastname':'Nom',
      'description':'Description'}},
  'submissions':{'name':'Soumission|Soumissions',
    'attributes':{'message':'Message'}},
  'tags':{'name':'Tag|Tags',
    'attributes':{'first_char':'Premi\u00e8re lettre',
      'type':'Type'}},
  'languages':{'name':'Langage|Langages',
    'attributes':[]},
  'publishers':{'name':'\u00c9diteur|\u00c9diteurs',
    'attributes':[]},
  'wikipedia-items':{'name':'Wikipedia Item|Wikipedia Items',
    'attributes':[]},
  'google-books':{'name':'Google Book|Google Books',
  ...
  'validation-inline':{'accepted':'Ce champ doit \u00eatre accept\u00e9.',
  ...
  'validation':{'accepted':'Le champ :attribute doit \u00eatre accept\u00e9.',
    ...
    'max':{'array':'Le tableau :attribute ne peut contenir plus de :max \u00e9l\u00e9ments.',
  ...
  'Lithuania':'Lituanie',
  'Load :size More':'Charger :size plus',
  'Log in':'Connexion',
  'Log Out':'D\u00e9connexion',
  ...
  'Not registered yet?':'Non encore inscrit(e) ?',
  'Content Managment':'Gestion du contenu',
  'Access Managment':'Gestion des acc\u00e8s',
  'Posts':'Articles',
  'Users':'Utilisateurs',
  'Impersonate disabled for this user.':'Usurpation d\u00e9sactiv\u00e9e pour cet utilisateur',
  'User created.':'Utilisateur ajout\u00e9.',
  'User updated.':'Utilisateur mis \u00e0 jour.',
  'User deleted.':'Utilisateur supprim\u00e9.',
  ':count users deleted.':':count utilisateurs supprim\u00e9s.',
  'Post created.':'Article ajout\u00e9.',
  'Post updated.':'Article mis \u00e0 jour.',
  'Post deleted.':'Article supprim\u00e9.',
  ':count posts deleted.':':count articles supprim\u00e9s.',
  'Stop impersonate':"Arr\u00eater l'usurpation",
  'Active':'Actif',
  'Inactive':'Inactif',
  'Show':'Voir',
  'Impersonate':'Usurper',
  'You are connected as :name, you can comeback to you own account from profile menu':'Vous \u00eates connect\u00e9 en tant que :name, vous pouvez \u00e0 tout moment revenir \u00e0 votre propre compte depuis le menu de profil.',
  'Application is on read only mode.':'Application en mode lecture seule.',
  'File Manager':'Gestionnaire de fichier',
  'Publish':'Publier',
  'Save as draft':'Sauvegarder en tant que brouillon',
  'Leave empty for auto generate the link.':'Laisser vide pour autog\u00e9n\u00e9rer le lien.',
  'Drag file here':'D\u00e9poser le fichier ici',
  'Drop file to upload':'Glisser le fichier pour transf\u00e9rer',
  'Select or drag a file':'S\u00e9lectionner ou glisser-d\u00e9poser un fichier',
  'Select or drag files':'S\u00e9lectionner ou glisser-d\u00e9poser des fichiers',
  'If future date, the post will be automatically posted at this date.':"Si date future, l'article sera automatiquement publi\u00e9e \u00e0 cette date.",
  'Search :query':'Rechercher le terme ":query"'},
  'vendor':{'enum':{'en':{'validation':{'enum':'The :attribute field is not a valid :enum.',
    'enum_index':'The :attribute field is not a valid index of :enum.',
    'enum_name':'The :attribute field is not a valid name of :enum.',
    'enum_value':'The :attribute field is not a valid value of :enum.',
    'enums':{'App\\Enums\\RoleEnum':{'super_admin':'Super admin',
      'admin':'Admin',
      'user':'User'},
    'App\\Enums\\PostStatusEnum':{'draft':'Draft',
      'scheduled':'Scheduled',
      'published':'Published'}}}},
  'fr':{'validation':{'enum':"Le champ :attribute n'est pas un :enum valide.",
    ...
    'enums':{'App\\Enums\\RoleEnum':{'super_admin':'Super administrateur',
      'admin':'Administrateur',
      'user':'Utilisateur'},
    'App\\Enums\\PostStatusEnum':{'draft':'Brouillon',
      'scheduled':'Planifi\u00e9',
      'published':'Publi\u00e9'}}}}}}}
}