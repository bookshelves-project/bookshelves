...
<![endif]-->
    ...
    <!--<![endif]-->
    <title>
        {{ $title ?? '' }} · Catalog on {{ config('app.name') }} Features
    </title>
                                    ...
                                    <div style="width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0 10px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <div
                                                                style="line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;">Get
                                                                    eBooks from web browser of your eReader.</p>
                                                            </div>
