<div x-show="$store.webreader.bookIsReady">
    <div x-show="$store.webreader.tutorialIsEnabled"
        class="fixed z-30 top-20 left-1/2 -translate-x-1/2 transform on-screen-tuto">
    ...
    <div :class="$store.webreader.tutorialIsEnabled ? 'on-screen-tuto-color' : ''"
        class="fixed z-20 grid grid-cols-3 w-full h-full">
