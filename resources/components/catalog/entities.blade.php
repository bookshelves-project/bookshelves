...
@php
$route = route('front.catalog');
switch ($type) {
case 'book':
$route = route('front.catalog.books.show', [
...
case 'serie':
$route = route('front.catalog.series.show', [
'author' => $item->meta?->author,
...
case 'author':
$route = route('front.catalog.authors.show', [
...
<img src="{{ $item->media_social }}" alt="{{ $item->title }}"
