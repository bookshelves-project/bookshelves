...
function createTOCItemElement(list, map, onclick) {
  let count = 0
...
export function createTOCView(toc, onclick) {
  ...
  $toc.addEventListener('focusout', () => {
    ...
    if (currentVisibleParent)
      currentVisibleParent.tabIndex = -1
