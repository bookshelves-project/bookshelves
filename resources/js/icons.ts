...
export type SvgName = 'api' | 'arrow-down' | 'arrow-left' | 'arrow-right' | 'audible' | 'book' | 'catalog' | 'chevron-down' | 'comic' | 'download' | 'ereader' | 'home' | 'info' | 'logo-text' | 'logo' | 'mail' | 'manga' | 'opds' | 'quill' | 'sign-out' | 'user' | 'x-mark' | 'default'
...
export const svgList: Record<SvgName, () => Promise<{ default: string }>> = {
  ...
  'sign-out': () => import('../../node_modules/unplugin-svg-transformer/cache/sign-out.ts'),
  'user': () => import('../../node_modules/unplugin-svg-transformer/cache/user.ts'),
