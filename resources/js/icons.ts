...
export type SvgName = 'api' | 'arrow-down' | 'arrow-left' | 'arrow-right' | 'audible' | 'book' | 'catalog' | 'chevron-down' | 'comic' | 'download' | 'ereader' | 'home' | 'info' | 'logo-text' | 'logo' | 'mail' | 'manga' | 'opds' | 'quill' | 'sign-out' | 'user' | 'default'
