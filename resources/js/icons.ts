...
export type SvgName = 'api' | 'arrow-down' | 'arrow-right' | 'audible' | 'book' | 'catalog' | 'chevron-down' | 'comic' | 'download' | 'ereader' | 'home' | 'info' | 'logo-text' | 'logo' | 'manga' | 'opds' | 'quill' | 'default'
