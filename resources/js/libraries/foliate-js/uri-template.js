...
export function replace(str, map) {
  return str.replace(regex, (_, operator, variableList) => {
...
export function getVariables(str) {
  return new Set(Array.from(str.matchAll(regex), ([,, variableList]) => variableList.split(',')
