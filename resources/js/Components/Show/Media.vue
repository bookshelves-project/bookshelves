    ...
    <div class="lg:grid grid-cols-6 gap-10 space-y-6 lg:space-y-0">
      <div :class="{
        ...
        <a :href="cover"
          ...
          <AppImg class="object-cover h-full w-full"
            :src="cover"
            :alt="title" />
        </a>
      </div>
      <section class="col-span-4">
        <div>
          ...
          <div v-if="propertiesList?.length || badgesList?.length"
            class="mt-4 text-sm">
            <div v-if="propertiesList"
              class="flex flex-wrap gap-3">
              <span v-for="property in propertiesList"
                :key="property">
                {{ property }}
              </span>
            </div>
            <div v-if="badgesList"
              ...
              <AppBadge v-for="badge in badgesList"
                :key="badge">
                {{ badge }}
              </AppBadge>
            </div>
