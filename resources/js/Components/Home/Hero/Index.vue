            ...
            <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div class="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                <p class="mt-8 text-pretty text-lg font-medium text-gray-400 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                  Your favorite audiobooks, ebooks, comics, and manga, all in one place. Discover new titles and enjoy a
                  seamless download experience.
                </p>
                <div class="mt-10 flex items-center gap-x-6">
                  <ILink href="/libraries"
                  ...
                  <a href="/opds"
                    ...
                    OPDS feed <span aria-hidden="true">→</span>
                  </a>
                </div>
              </div>
              <div class="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
                <div
                  ...
                  <HomeHeroImage :src="hero.posters?.one"
                    :ready="hero.ready" />
                </div>
                <div class="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
                  <HomeHeroImage :src="hero.posters?.two"
                    :ready="hero.ready" />
                  <HomeHeroImage :src="hero.posters?.three"
                    :ready="hero.ready" />
                </div>
                <div class="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                  <HomeHeroImage :src="hero.posters?.four"
                    :ready="hero.ready" />
                  <HomeHeroImage :src="hero.posters?.five"
                    :ready="hero.ready" />
                </div>
              </div>
            </div>
