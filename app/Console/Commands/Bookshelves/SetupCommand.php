...
class SetupCommand extends Command
{
    ...
    protected $signature = 'bookshelves:setup
                            ...
                            {--b|books : AssetsCommand for books}
                            {--a|authors : AssetsCommand for authors}
                            {--s|series : AssetsCommand for series}
                            ...
                            {--I|installation : shortcut to select -efFbasCS}
                            {--N|new : shorcut for -Fbas}';
     ...
     * @var string
     */
    protected $description = 'Setup command to execute multiple commands into one: GenerateCommand, AssetsCommand, SampleCommand.';
    ...
    public function handle()
    {
        ...
        $installation = $this->option('installation') ?? false;
