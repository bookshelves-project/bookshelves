...
class BookConverter
{
    ...
    private function syncLanguage(): self
    {
        ...
        if ($this->ebook->getFormat() === EbookFormatEnum::AUDIOBOOK) {
            $lang = BookshelvesUtils::audiobookParseLang($this->ebook->getLanguage(), $this->ebook->getExtra('comment'));
        }
    ...
    private function createBook(): ?Book
    {
        ...
        if ($this->ebook->getFormat() === EbookFormatEnum::AUDIOBOOK) {
            $title = BookshelvesUtils::audiobookParseTitle($this->ebook->getTitle());
